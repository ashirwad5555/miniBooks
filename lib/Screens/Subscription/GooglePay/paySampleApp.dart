      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: const Image(
              image: NetworkImage("https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Google_Pay_Logo.svg/1200px-Google_Pay_Logo.svg.png"),
              height: 350,
            ),
          ),
          const Text(
          ...
          const SizedBox(height: 5),
          const Text(
            'This is the premium subscription valid for lifetime',
            style: TextStyle(
              color: Color(0xff777777),
              fontSize: 15,
            ),
